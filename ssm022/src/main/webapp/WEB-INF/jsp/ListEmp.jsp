...
<body>
  <!--  在页面渲染数据到一个table中 -->
   ...
   <h3 align="center" style='color:red'>欢迎:<shiro:principal></shiro:principal></h3>
   <h3><a href='${pageContext.request.contextPath}/user/logout'>退出登录</h3>
   <h3 align="center">
    <!-- /工程名  /webdemo 
       跳转到添加员工的页面
    -->
      ...
      <c:forEach items="${pageBean.list}"  var="e">
        <tr>
         ...
         <shiro:hasRole name="管理员">
            <a href="${pageContext.request.contextPath}/emp/delete?empno=${e.empno}">删除</a>
